...
global__text__sentiment__NRC__overall_posneg <- "Overall Pos/Neg"
global__text__sentiment__NRC__overall_granular <- "Overall Granular"
global__text__sentiment__NRC__top_words_posneg <- "Top Words Pos/Neg"
global__text__sentiment__NRC__top_words_granular <- "Top Words Granular"
global__text__sentiment__NRC__values <- c(global__text__sentiment__NRC__overall_posneg,
                                          global__text__sentiment__NRC__overall_granular,
                                          global__text__sentiment__NRC__top_words_posneg,
                                          global__text__sentiment__NRC__top_words_granular)
...
var_plots__default_values <- list(
    ...
    'var_plots__convert_numerics_to_categoric' = FALSE,
    'var_plots__convert_numerics_to_categoric__num_groups' = 10,
    'var_plots__convert_numerics_to_categoric__x_cut_sequence' = "",
    'var_plots__convert_numerics_to_categoric__y_cut_sequence' = "",
    ...
    'var_plots__text__sentiment__NRC' = global__text__sentiment__NRC__values[1],
...
var_plots__variable_types <- list(
    ...
    'var_plots__convert_numerics_to_categoric' = 'updateCheckboxInput',
    'var_plots__convert_numerics_to_categoric__num_groups' = 'updateSliderInput',
    'var_plots__convert_numerics_to_categoric__x_cut_sequence' = 'updateTextInput',
    'var_plots__convert_numerics_to_categoric__y_cut_sequence' = 'updateTextInput',
    ...
    'var_plots__text__sentiment__NRC' = 'updateRadioButtons',
