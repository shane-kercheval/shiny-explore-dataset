            ...
            column(3,
                ...
                bsCollapse(id='var_plots__bscollapse', open='Variables', multiple=TRUE,
                    ...
                    bsCollapsePanel(
                        ...
                        # Text Options
                        ######################################################################################
                        radioButtons(inputId='var_plots__text__stem_words',
                                     label="Stem:",
                                     choices=global__text__stemming_types,
                                     selected=var_plots__default_values[['var_plots__text__stem_words']],
                                     inline=TRUE,
                                     width='100%'),
                        bsTooltip(id='var_plots__text__stem_words',
                                  title="\\'Stemming\\' changes words like \\'stopped\\' and \\'stopping\\' to \\'stop\\'",
                                  placement='top', trigger='hover'),
                        radioButtons(inputId='var_plots__text__graph_type',
                                     label="Graph Type",
                                     choices=global__text__graph_type__values,
                                     selected=var_plots__default_values[['var_plots__text__graph_type']],
                                     inline=TRUE,
                                     width='100%'),
                        radioButtons(inputId='var_plots__text__count_type',
                                     label="Count Type",
                                     choices=global__text__graph_type_count__values,
                                     selected=var_plots__default_values[['var_plots__text__count_type']],
                                     inline=TRUE,
                                     width='100%'),
                        radioButtons(inputId='var_plots__text__sentiment_dictionary',
                                     label="Sentiment Dictionary",
                                     choices=global__text__sentiment_dictionary__values,
                                     selected=var_plots__default_values[['var_plots__text__sentiment_dictionary']],
                                     inline=TRUE,
                                     width='100%'),
                        radioButtons(inputId='var_plots__text__sentiment__bing',
                                     label="Bing Dictionary Options",
                                     choices=global__text__sentiment__bing__values,
                                     selected=var_plots__default_values[['var_plots__text__sentiment__bing']],
                                     inline=TRUE,
                                     width='100%'),
                        radioButtons(inputId='var_plots__text__sentiment__NRC',
                                     label="NRC Dictionary Options",
                                     choices=global__text__sentiment__NRC__values,
                                     selected=var_plots__default_values[['var_plots__text__sentiment__NRC']],
                                     inline=TRUE,
                                     width='100%'),
                        # selectInput(inputId='var_plots__text__graph_type',
                        #             label='Graph Type',
                        #             choices=global__text__graph_type__values,
                        #             selected=var_plots__default_values[['var_plots__text__graph_type']],
                        #             multiple=FALSE,
                        #             selectize=TRUE,
                        #             width='100%'),
                        selectInput(inputId='var_plots__text__freq_comp_group',
                        ...
                        checkboxInput(inputId='var_plots__text__scale_free_facet',
                                      ...
                                      width='100%'),
                        sliderInput(inputId='var_plots__text__top_n_words',
                                    label="Top X Words",
                                    min=5,
                                    max=50,
                                    step=5,
                                    value=var_plots__default_values[['var_plots__text__top_n_words']],
                                    width='100%'),
                        bsTooltip(id='var_plots__text__top_n_words',
                                  title="Only includes top X words.",
                                  placement='top', trigger='hover'),
                        ######################################################################################
                        ...
                        bsTooltip(id='var_plots__numeric_aggregation_count_minimum',
                                  ...
                                  placement='top', trigger='hover'),
                        radioButtons(inputId='var_plots__ts_graph_type',
                                     label="Type:",
                                     choices=global__ts_graph_type__options,
                                     selected=var_plots__default_values[['var_plots__ts_graph_type']],
                                     inline=TRUE,
                                     width='100%'),
