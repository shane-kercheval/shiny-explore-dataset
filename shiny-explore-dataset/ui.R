                ...
                bsCollapse(id='var_plots__bscollapse', open='Variables', multiple=TRUE,
                    ...
                    bsCollapsePanel(
                        ...
                        checkboxInput(inputId='var_plots__annotate_points',
                                     label='Show Values', value=FALSE, width='100%'),
                        ...
                        checkboxInput(inputId='var_plots__numeric_numeric_show_resampled_confidence_interval',
                                      label='Show Confidence Interval (Resampling):', value=FALSE, width='100%'),
                        uiOutput('var_plots__order_by_variable__UI'),
                        tags$div(id='div_var_plots__group_barchar_controls',
                            # checkboxInput(inputId='var_plots__order_by_count',
                            #               label='Order By Totals', value=FALSE, width='100%'),
                    ...
                    bsCollapsePanel(
                        ...
                        textInput(inputId='var_plots__custom_y_axis_label', label="Y-Axis Label", width='100%', value=NULL),
                        textInput(inputId='var_plots__custom_caption', label="Caption", width='100%', value=NULL),
                        textInput(inputId='var_plots__custom_tag', label="Tag", width='100%', value=NULL),
                        ...
                        bsTooltip(id='var_plots__pretty_text',
                                  ...
                                  placement='top', trigger='hover'),
                        textAreaInput('var_plots__vertical_annotations', "Vertical Annotations", value = "", width = '100%', height = 150),
                        textAreaInput('var_plots__horizontal_annotations', "Horizontal Annotations", value = "", width = '100%', height = 150),
                        style='default'
                    ),
                    bsCollapsePanel(
                        'Map Options',
                        shinyjs::hidden(
                            ...
                            textInput(inputId='var_plots___map_borders_database', label="Borders Database", width='100%', value = NULL),
                            textInput(inputId='var_plots___map_borders_regions', label="Regions", width='100%', value = NULL)
                        ),
